   ...
   <nav class="navbar">
     ...
     <?php
      ...
      if (isset($_SESSION['user_id'])) {
         echo '<a href="http://localhost/Travel/login-reg-main/index.php"> Hi, ' . $_SESSION['Username'] . '!</a> <a href="login-reg-main/logout.php" class="btn btn-warning">Logout</a>';
      } else {
...
<section class="footer">
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="#"> <i class="fas fa-map"></i> Islamabad, Pakistan - 2024  </a>
      </div>
      <div class="box">
         <h3>follow us</h3>
